 ...
 * 
 * What it does:
 * This controller handles the Customer's actions: Booking a slot and Viewing/Cancelling their own appointments.
 */
@RestController
...
public class AppointmentController {
     ...
     * 2. LOGIC: 
     *    - Verifies ownership.
     *    - Frees up the slot (so someone else can take it).
